...
import com.zkjd.lingdong.databinding.TuotuotieSettingDialogTipsBinding;
 ...
 * 用于显示使用提示信息
 */
public class TuoTuoTieSettingTipsFragmentDialog extends BaseDialogFragment<ViewBinding> {
    ...
    public TuoTuoTieSettingTipsFragmentDialog() {
     ...
     */
    public static TuoTuoTieSettingTipsFragmentDialog newInstance(String title, String content) {
        TuoTuoTieSettingTipsFragmentDialog dialog = new TuoTuoTieSettingTipsFragmentDialog();
    ...
    protected ViewBinding createViewBinding(LayoutInflater inflater, ViewGroup container) {
        return TuotuotieSettingDialogTipsBinding.inflate(inflater,container,false);
    }
