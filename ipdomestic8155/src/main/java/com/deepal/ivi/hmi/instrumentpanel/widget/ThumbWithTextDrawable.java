...
public class ThumbWithTextDrawable extends Drawable {
    ...
    public void draw(Canvas canvas) {
        ...
        canvas.save();
        // 计算 thumb_main_icon 在thumb视图中的中心点
        int thumbMainIconCenterX = mMainIcon.getLeft() + mMainIcon.getWidth() / 2;
        ...
        // 计算需要平移的位置，使得thumbMainIcon的中心与bounds中心对齐
        float translateX = bounds.centerX() - thumbMainIconCenterX;//以圆圈的中心为标准进行对齐。
